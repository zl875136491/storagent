...
ACTION_LABELS = {
  ...
  "application.domain.add": "添加应用来源",
  "application.domain.delete": "删除应用来源",
  ...
  "unmanaged_bucket.delete": "清理未纳管存储桶",
  "unmanaged_bucket.retain": "登记未纳管存储桶保留",
  "unmanaged_bucket.retention_release": "取消未纳管存储桶保留",
  "region.create": "创建区域",
  "region.offline": "下线区域",
